					...
					<div class="col-md-3 col-sm-6">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<p style="color: #A7A8AA">Lorem ipsum dolor sit amet,
								...
								<div id="downloadModal" class="modal fade" role="dialog">
									<div class="modal-dialog">
										...
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 style="text-align: left;" class="modal-title">Download
													${bean.getName() }</h4>
											</div>
											<div class="modal-body">
												<p>You must proceed to checkout in order to download
													this content to your device. Please click 'Add to Cart'
													below!</p>
											</div>
											<div class="modal-footer">
												<a href="addtocart/${bean.getIsbn()}+${bean.getPrice()}"
